package com.uwu.common.core.utils.poi;

import com.uwu.common.core.annotation.Excel;
import com.uwu.common.core.annotation.Excel.ColumnType;
import com.uwu.common.core.annotation.Excel.Type;
import com.uwu.common.core.annotation.Excels;
import com.uwu.common.core.utils.core.*;
import com.uwu.common.core.utils.file.FileTypeUtil;
import com.uwu.common.core.utils.file.ImageUtil;
import com.uwu.common.core.utils.sql.DateUwuUtil;
...
public class ExcelUtil<T> {
    ...
    public String parseDateToStr(String dateFormat, Object val) {
        ...
        if (val instanceof Date) {
            str = DateUwuUtil.parseDateToStr(dateFormat, (Date) val);
        } else if (val instanceof LocalDateTime) {
            str = DateUwuUtil.parseDateToStr(dateFormat, DateUwuUtil.toDate((LocalDateTime) val));
        } else if (val instanceof LocalDate) {
            str = DateUwuUtil.parseDateToStr(dateFormat, DateUwuUtil.toDate((LocalDate) val));
        } else {
            str = val.toString();
        }
        return str;
