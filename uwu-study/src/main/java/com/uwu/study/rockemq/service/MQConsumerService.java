package com.uwu.study.rockemq.service;
...
public class MQConsumerService {
    ...
    @Service
    @RocketMQMessageListener(topic = "water", selectorExpression = "tag1", consumerGroup = "Con_Group_One")
    ...
    @Service
    @RocketMQMessageListener(topic = "water", consumerGroup = "Con_Group_Two")
    ...
    @Service
    @RocketMQMessageListener(topic = "water", selectorExpression = "tag2", consumerGroup = "Con_Group_Three")
